...
#onnx_file_name = 'resource/MiDaS/midas_1x256x256xBGRxByte.onnx'
onnx_file_name = 'resource/MiDaS/midas_1x384x384xBGRxByte.onnx'
#input_size = 256
input_size = 384
...
while hasFrame:
    ...
    img_in = np.expand_dims(img1, axis=0) #.astype(np.bytes)
